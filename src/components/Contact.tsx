        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <a href="/Ayush_Jha_Resume.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[#e0e0e0] hover:text-primary transition-colors group">
                <FileText size={18} className="text-primary" />
                <span className="font-mono text-[0.85rem]">Download Resume</span>
              </a>
            </div>
            
            <div className="mt-auto pt-8">
              <div className="text-[0.8rem] opacity-60">Ahmedabad, India</div>
            </div>
          </motion.div>
